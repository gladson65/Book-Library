function Sciencefiction(props) {
    ...
    return(
        <>
            ...
            <div className="topRatedCard p-5 rounded-xl h-full shadow-sm bg-slate-800 hover:bg-slate-900">
                
                <img src={coverImages} alt="product-image" className="w-full rounded-lg h-80 object-cover object-top drop-shadow-[0_10px_10px_skyblue]"/>
